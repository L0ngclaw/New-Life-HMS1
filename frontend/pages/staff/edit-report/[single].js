    ...
    const fetchSingleReport = async (single) => {
        await axios.get(`/api/get-single-lab-report`, {
            ...
            .then((res) => {
                ...
                setRedBloodCellCount(res.data.RedBloodCellCount);
                setHemoglobin(res.data.Hemoglobin);
                setHematocrit(res.data.Hematocrit);
                setType(res.data.Type);
                setPlateletCount(res.data.PlateletCount);
                setWhiteBloodCellCount(res.data.WhiteBloodCellCount);
            })
    }

    const updateReport = async () => {
        await axios.put(`/api/update-single-lab-report`, {
            id: single,
            name: name,
            email: patientEmail,
